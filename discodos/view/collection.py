...
class CollectionViewCommandline(
    ...
    def tab_stats(
        ...
        sales_listings_forsale, sales_listings_sold,
        sales_price_average, sales_price_average_lower,
        ...
        stats = [
            ...
            ['Sales listings (Price Average)', sales_price_average],
            ['Sales listings (Price <15 Average)', sales_price_average_lower],
